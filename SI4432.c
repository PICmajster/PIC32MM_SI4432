...
void SI4432_Initialize (void){
   ...
   /*Modem settings GFSK for RX, AFC Enable*/
    ...
    SpiWriteRegister(SI4432_REG_6D_TX_POWER , SI4432_TX_POWER_14DBM);
    ...
    /*Set IRQ
     Enable Packet Sent.
     */
    SpiWriteRegister(SI4432_REG_05_INTERRUPT_ENABLE1 , 0x04);
    SpiWriteRegister(SI4432_REG_06_INTERRUPT_ENABLE2 , 0x00);
